...
export function FaucetView() {
  ...
  const { setCurrentView, hasClaimedToday, setHasClaimedToday, usdcBalance, setUsdcBalance, setLastClaimTimestamp } = useAppStore();
  ...
  const handleClaim = async () => {
    ...
    try {
      await createFaucetTx(signAndExecuteTransactionBlock);
